				...
				<tbody>
					...
					?>
						<tr>
							...
							<td class="text-right"><?= number_format($row['start_bid'], 2) ?></td>
							<td class="">
								<div style="line-height:1em">
									<div><b> <?= $row['bid_end_datetime'] ?></b></div>
								</div>
							</td>
						</tr>
					<?php endwhile; ?>
