	...
	<div class="col-lg-10 col-md-11 col-sm-12 col-xs-12">
		<div class="card rounded-0 shadow">
			<div class="card-footer py-1 text-center">
				<a href="./?page=models/BiddingCars"><button class="btn btn-flat btn-sm btn-primary bg-gradient-primary" href="./?page=models/BiddingCars.php" type="button" id="add_Biddingvehicle"><i class="far fa-plus-square"></i> Add Bidding Vehicle</button></a>
				...
				<div class="container-fluid">
					<table class="table table-stripped table-bordered" id="vehicle-list">
						...
						<thead>
							...
							<th class="p-1 text-center">Year</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="p-1 align-middle text-right"><?= $row['Year'] ?></td>
