...
<div class="container-fluid">
    <form action="" id="vehicle-form">
        ...
        <div class="row">
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="mileage" class="control-label">Cylinder</label>
                <input type="text" name="Cylinder" id="Cylinder" class="form-control form-control-sm rounded-0" value="<?php echo isset($Cylinder) ? $Cylinder : ''; ?>"  required/>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <input type="number" step="any" name="year" id="year" class="form-control form-control-sm rounded-0 text-right" value="<?php echo isset($Year) ? $Year : ''; ?>"  required/>
            </div>
        <div class="row">
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="variant" class="control-label">Technologies</label>
                <input type="text" name="Technologies" id="Technologies" class="form-control form-control-sm rounded-0" value="<?php echo isset($Technologies) ? $Technologies : ''; ?>"  required/>
            </div>
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="mileage" class="control-label">Description</label>
                <input type="text" name="Description" id="Description" class="form-control form-control-sm rounded-0" value="<?php echo isset($Description) ? $Description : ''; ?>"  required/>
            </div>
        </div>
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="mileage" class="control-label">Car Pic</label>
                <input type="text" name="Pic" id="Pic" class="form-control form-control-sm rounded-0" value="<?php echo isset($Pic) ? $Pic : ''; ?>"  />
            </div>
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
