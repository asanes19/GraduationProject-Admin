...
<div class="container-fluid">
    ...
    <div class="d-flex w-100">
        ...
        <div class="col-9 mb-0 border"><?= isset($Description) ? $Description : '' ?></div>
    </div>
    <div class="d-flex w-100">
        <div class="col-3 mb-0 border bg-gradient-secondary">Technologies</div>
        <div class="col-9 mb-0 border"><?= isset($Technologies) ? $Technologies : '' ?></div>
    </div>
    <div class="d-flex w-100">
