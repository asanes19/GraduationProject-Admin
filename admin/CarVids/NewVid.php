...
if(isset($_POST['submit'])){
    ...
    for($i=0;$i<$imagecount;$i++){
        ...
        $folder= "CarVids/vids/" .$image_name;
        if(move_uploaded_file($tmp_name, $folder)){
            $sql= "INSERT INTO `vids` (`id`,`car_id`,`vids`) VALUES ('', '$name', '$folder')";
...
<div class="row mt-n4 align-items-center justify-content-center flex-column">
	<div class="col-lg-10 col-md-11 col-sm-12 col-xs-12">
      ...
      <label for="image">Vid : </label>
      <input type="file" name="image[]" multiple id = "image" value=""> <br> <br>
